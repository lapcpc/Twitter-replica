...
function Sidebar() {
  return (
    <div className='sticky top-0 col-span-1 xl:col-span-2 mr-6  pt-1  justify-between flex flex-col h-screen items-end'>
      <div className=' space-y-4  '>
        ...
        <button className='text-center    bg-sky-500 hover:bg-sky-600 rounded-full text-white p-1 px-3 xl:py-3 font-medium text-lg w-fit xl:w-full'> <p className='hidden xl:inline'>Twittear</p> <p className='inline xl:hidden p-0'>+</p> </button>
